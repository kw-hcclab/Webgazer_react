!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(['exports'], t)
    : t(((e = e || self).gazefilter = {}));
})(this, function (e) {
  'use strict';
  let t,
    n = new TextDecoder('utf-8', { ignoreBOM: !0, fatal: !0 });
  n.decode();
  let r = null;
  function i() {
    return (
      (null !== r && r.buffer === t.memory.buffer) ||
        (r = new Uint8Array(t.memory.buffer)),
      r
    );
  }
  function a(e, t) {
  ...
  function h() {
    return (
      (null !== p && p.buffer === t.memory.buffer) ||
        (p = new Int32Array(t.memory.buffer)),
      p
    );
  }
  let g = null;
  function w(e, n) {
    return ((null !== g && g.buffer === t.memory.buffer) ||
      (g = new Float32Array(t.memory.buffer)),
  ...
  function m() {
    try {
      ...
      var e = h()[s / 4 + 0],
        n = h()[s / 4 + 1],
        r = ((a = e), (o = n), i().subarray(a / 1, a / 1 + o)).slice();
  ...
  class S {
    ...
    faceRect() {
      try {
        ...
        var e = h()[o / 4 + 0],
          n = h()[o / 4 + 1],
          r = ((i = e), (a = n), h().subarray(i / 4, i / 4 + a)).slice();
  ...
  const T = Object.freeze({ alpha: !0, depth: !1, antialias: !1 }),
  ...
  var B = function () {
      if (!navigator.mediaDevices)
        throw Error(
          'No `navigator.mediaDevices` capability. Maybe try `https`?'
        );
      if (
        ...
        (L.hidden = !0),
        (z = L.getContext('webgl', T)),
        !z)
      )
        throw Error('Cannot create WebGL rendering context');
      (P = (function (e, t, n) {
        let r = e.createProgram(),
          i = k(
            e,
            e.VERTEX_SHADER,
            'precision mediump float;attribute vec2 a_texCoord;varying vec2 v_texCoord;void main(){gl_Position=vec4(a_texCoord,0.,1.);v_texCoord=a_texCoord*0.5+0.5;}'
          ),
          a = k(
            e,
            e.FRAGMENT_SHADER,
            'precision mediump float;uniform sampler2D u_texture;varying vec2 v_texCoord;const vec3 convert=vec3(0.299,0.587,0.114);void main(){vec4 pixel=texture2D(u_texture,v_texCoord);pixel.a=dot(pixel.rgb,convert);gl_FragColor=pixel;}'
          );
        if (
          (e.attachShader(r, i),
          e.attachShader(r, a),
        ...
        z.useProgram(P),
        (I = z.getUniformLocation(P, 'u_texture')),
        (D = z.createTexture()),
        z.bindTexture(z.TEXTURE_2D, D),
        z.texParameteri(z.TEXTURE_2D, z.TEXTURE_WRAP_S, z.CLAMP_TO_EDGE),
        z.texParameteri(z.TEXTURE_2D, z.TEXTURE_WRAP_T, z.CLAMP_TO_EDGE),
        z.texParameteri(z.TEXTURE_2D, z.TEXTURE_MIN_FILTER, z.LINEAR),
        z.texParameteri(z.TEXTURE_2D, z.TEXTURE_MAG_FILTER, z.NEAREST),
        z.activeTexture(z.TEXTURE0),
        z.uniform1i(I, 0),
        (N = z.createBuffer()),
        z.bindBuffer(z.ARRAY_BUFFER, N),
        z.bufferData(z.ARRAY_BUFFER, R, z.STATIC_DRAW),
        (U = z.createBuffer()),
        z.bindBuffer(z.ELEMENT_ARRAY_BUFFER, U),
        z.bufferData(z.ELEMENT_ARRAY_BUFFER, C, z.STATIC_DRAW),
        (O = z.getAttribLocation(P, 'a_texCoord')),
        z.vertexAttribPointer(O, 2, z.FLOAT, !1, 0, 0),
        z.enableVertexAttribArray(O);
    },
    F = async function (e) {
      ...
      let n = await navigator.mediaDevices.getUserMedia(t),
        r = (function (e) {
      ...
      return (
        ...
        (x.srcObject = n),
        await x.play(),
        { id: i.deviceId, width: a, height: o, frameRate: s, label: A(r.label) }
      );
    },
    j = function (e) {
      z.texImage2D(z.TEXTURE_2D, 0, z.RGBA, z.RGBA, z.UNSIGNED_BYTE, x),
        z.drawElements(z.TRIANGLES, 6, z.UNSIGNED_SHORT, 0),
        z.readPixels(
          0,
          0,
          z.drawingBufferWidth,
          z.drawingBufferHeight,
          z.RGBA,
          z.UNSIGNED_BYTE,
          e
        );
    ...
    M = function () {
      x.srcObject &&
        (x.srcObject = x.srcObject.getTracks().forEach((e) => e.stop()));
    },
    X = function () {
  ...
  var te = {
      ...
      removeListener: function (e, t) {
        ...
        for (let e = 0, r = n.length; e < r; e++)
          if (n[e] === t) return void n.splice(e, 1);
      },
      calibrate: function (e, n, r, i = 0.5) {
        X() &&
          ((function (e, n, r, i, a) {
      ...
      setCalibration: function (e) {
        if (v() != e.version)
          throw new Error('incompatible calibration and module versions');
        var n, r, a;
        (n = e.data),
          (r = (function (e, t) {
    ...
    ne = {
      frame: (e, t) => {
        if (
          ...
          for (let r = 0; r < t.shapeSize(); r++)
            e.beginPath(),
              e.arc(n[2 * r], n[2 * r + 1], 2, 0, 2 * Math.PI),
              e.fill();
          e.strokeStyle = 'red';
          let [r, i, a, o] = t.pupilArray();
          e.beginPath(),
            e.arc(r, i, 3, 0, 2 * Math.PI),
            e.stroke(),
            e.beginPath(),
            e.arc(a, o, 3, 0, 2 * Math.PI),
            e.stroke();
        }
      },
      change: (e, t) => {
  ...
  var ce = {
    ...
    setCanvas: function (e) {
      if (!(e instanceof HTMLCanvasElement))
        throw TypeError('value is not a canvas type');
      if (((re = e.getContext('2d')), null === re))
        throw TypeError('Cannot get 2d context from canvas');
      te.videoElement() && oe(!0),
        te.addListener('filter', ae),
        te.addListener('pause', se),
        te.addListener('change', oe);
    },
    removeCanvas: function () {
      te.removeListener('filter', ae),
        te.removeListener('pause', se),
        te.removeListener('change', oe),
        te.videoElement() && re && oe(!1),
        (re = null);
    },
  };
  class ue {
    ...
    async push(e) {
      this.chunks.push(e),
        this.length >= this.capacity && (await this.onfull(this.free()));
    }
    setCapacity(e, t) {
      if (0 == e) (this.onfull = void 0), (this.capacity = void 0);
      else {
  ...
  class de extends ue {
    push(e) {
      return (
        0 == this.length && super.push(e.headerCSV()), super.push(e.toCSV())
      );
    }
    free() {
  ...
  function Le(e) {
    const t = performance.now();
    e
      ? pe.push(t, 'tracker', 'connect', { ...e })
      : pe.push(t, 'tracker', 'dispose');
  }
  function ze() {
    te.addListener('filter', Ce),
      te.addListener('pause', xe),
      te.addListener('change', Le),
      (Ae = !0);
  }
  function Pe() {
    te.removeListener('filter', Ce),
      te.removeListener('pause', xe),
      te.removeListener('change', Le),
      (Ae = !1);
  }
  function Ie(e, t, n, r) {
    !(function () {
      if (!window.MediaRecorder)
        throw new Error(
          'Need `MediaRecorder` for webcam recording which is not supported by browser.'
        );
    })();
    let i = new MediaRecorder(e, {
      mimeType: 'video/webm',
  ...
  var Me = {
    start(e, t) {
      Ue ||
        ...
        (Fe.hidden = !0),
        (je = Fe.getContext('2d')),
        (Be = Fe.captureStream(e.frameRate)),
        (Ue = Ie(
          Be,
          (e) => pe.push(e.timeStamp, 'webcam', e.type),
          Xe,
          e.bitRate
        )),
        e.bufferSize && De.setCapacity(e.bufferSize, t),
        te.videoElement() && Ve({}),
        te.addListener('change', Ve),
        te.addListener('filter', We),
        Ue.start(e.bufferSize ? 33 : void 0));
    },
    pause() {
      Ue && Ue.pause();
    },
    ...
    async stop() {
      if (Ue)
        return (
          te.removeListener('change', Ve),
          te.removeListener('filter', We),
          await Oe(Ue, (e) => pe.push(e.timeStamp, 'webcam', 'stop')).then(
            () => {
  ...
  var He = {
    async start(e, t) {
      (Ye = await navigator.mediaDevices.getDisplayMedia({
        video: { cursor: 'always', displaySurface: e.displaySurface },
        audio: !1,
      })),
        ($e = Ie(
          Ye,
          (e) => pe.push(e.timeStamp, 'screen', e.type),
          Je,
          e.bitRate
        ));
      let n = Ye.getVideoTracks()
        .find((e) => e.enabled)
        .getSettings();
      ($e.onstart = (e) => pe.push(e.timeStamp, 'screen', e.type, { ...n })),
        e.bufferSize && Ge.setCapacity(e.bufferSize, t),
        $e.start(e.bufferSize ? 33 : void 0);
    },
    pause() {
      $e && $e.pause();
    },
    ...
    async stop() {
      if ($e)
        return (
          await Oe($e, (e) => pe.push(e.timeStamp, 'screen', 'stop')).then(
            () => {
              ($e = void 0),
                Ye.getTracks().forEach((e) => e.stop()),
                (Ye = void 0);
            }
          ),
          await void 0,
  ...
  var Ke = {
    ...
    async stop() {
      ...
      return (
        await Promise.all(
          this.map((t, n) => t.stop().then((t) => (t ? (e[n] = t) : null)))
        ),
        e
      );
    },
  ...
  var tt = {
    start: async function (e = {}, t) {
      ...
      return (
        (Ze = !0),
        Ke.event.push(performance.now(), 'recorder', 'start', te.deviceInfo()),
        e.filter || (e.filter = !0),
        e.event || (e.event = !0),
        e.mouse || (e.mouse = !1),
        e.webcam || (e.webcam = !1),
    ...
    toggle: function () {
      ...
      return (
        Qe
          ? (Ke.event.push(e, 'recorder', 'resume'), Ke.resume(), (Qe = !1))
          : (Ke.event.push(e, 'recorder', 'pause'), Ke.pause(), (Qe = !0)),
        !Qe
      );
    },
    stop: async function () {
  ...
  (e.findDevices = async function () {
    let e = (await navigator.mediaDevices.enumerateDevices()).filter(
      (e) => 'videoinput' === e.kind
    );
    return (
      (e = JSON.parse(JSON.stringify(e))),
      (e = e.map(
        (e, t) => ((e.label = e.label ? A(e.label) : 'video input ' + t), e)
      )),
      e
    );
  }),
    (e.init = async function (e = './gazefilter.wasm') {
      ...
      try {
        await (async function e(n) {
          ...
          (r.wbg.__wbindgen_string_new = function (e, t) {
            ...
            (r.wbg.__wbg_newwithbyteoffsetandlength_3c8748473807c7cf =
              function (e, t, n) {
                return c(new Uint8Array(u(e), t >>> 0, n >>> 0));
              }),
            (r.wbg.__wbg_newwithbyteoffsetandlength_193d0d8755287921 =
              function (e, t, n) {
      ...
      if ('0.7.0' !== v())
        throw new Error(
          `Incompatible gazefilter.js v0.7.0 with gazefilter.wasm v${v()}.`
        );
      var n, r;
      ($ = new S()),
        (Y = new E()),
        delete $.__proto__.free,
        delete Y.__proto__.free,
        window.screen &&
          ((n = screen.width), (r = screen.height), t.setScreen(n, r)),
        (H = !0);
    }),
    (e.recorder = tt),
    (e.tracker = te),
